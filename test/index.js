...
test('it works with leading zeros and milliseconds', function (t) {
  t.equal(f(999, { leading: true, milliseconds: true }), '00:00.999', 'anything under a second is correctly displayed')
  t.equal(f(1000, { leading: true, milliseconds: true }), '00:01.000', 'check 1000 milliseconds is a second')
  t.equal(f(1000 * 2 - 1, { leading: true, milliseconds: true }), '00:01.999', 'displays 1999 as 00:01.999')
  t.equal(f(1000 * 60, { leading: true, milliseconds: true }), '01:00.000', 'check 60 seconds is a minute')
  t.equal(f(1000 * 60 - 1, { leading: true, milliseconds: true }), '00:59.999', 'check 59.999 seconds looks ok')
  t.equal(f(1000 * 60 * 60, { leading: true, milliseconds: true }), '01:00:00.000', 'check 60 minutes is an hour')
  t.equal(f(1000 * 60 * 60 - 1, { leading: true, milliseconds: true }), '59:59.999', 'check 59 minutes with 999 milliseconds looks ok')
  t.equal(f(1000 * 60 * 60 * 24, { leading: true, milliseconds: true }), '1:00:00:00.000', 'check 24 hours is a day')
  t.equal(f(1000 * 60 * 60 * 24 - 1, { leading: true, milliseconds: true }), '23:59:59.999', 'check 23 hours with 999 milliseconds looks okay')
  t.equal(f(1000 * 60 * 60 * 24 * 365, { leading: true, milliseconds: true }), '365:00:00:00.000', 'check 365 days is too long to care')
  t.end()
})
...
test('it works with negarive duration and milliseconds', function (t) {
  ...
  t.equal(f(-1000 * 60, { milliseconds: true }), '-1:00.000', 'check -60 seconds is a minute')
  t.equal(f(-1000 * 60 + 1, { milliseconds: true }), '-0:59.999', 'check -59.999 seconds looks ok')
  t.equal(f(-1000 * 60 * 60, { milliseconds: true }), '-1:00:00.000', 'check -60 minutes is an hour')
  t.equal(f(-1000 * 60 * 60 + 1, { milliseconds: true }), '-59:59.999', 'check -59 minutes with 999 milliseconds looks ok')
  t.equal(f(-1000 * 60 * 60 * 24, { milliseconds: true }), '-1:00:00:00.000', 'check -24 hours is a day')
  t.equal(f(-1000 * 60 * 60 * 24 + 1, { milliseconds: true }), '-23:59:59.999', 'check -23 hours with 999 milliseconds looks okay')
  t.equal(f(-1000 * 60 * 60 * 24 * 365, { milliseconds: true }), '-365:00:00:00.000', 'check -365 days is too long to care')
  t.end()
})
