...
test('it works with leading zeros', function (t) {
  t.equal(f(999, { leadingZeros: true }), '00:00', 'anything under a second is 00:00')
  t.equal(f(1000, { leadingZeros: true }), '00:01', 'check 1000 milliseconds is a second')
  t.equal(f(1000 * 2 - 1, { leadingZeros: true }), '00:01', 'rounds 1999 down to 00:01')
  t.equal(f(1000 * 60, { leadingZeros: true }), '01:00', 'check 60 seconds is a minute')
  t.equal(f(1000 * 60 - 1, { leadingZeros: true }), '00:59', 'check 59 seconds looks ok')
  t.equal(f(1000 * 60 * 60, { leadingZeros: true }), '01:00:00', 'check 60 minutes is an hour')
  t.equal(f(1000 * 60 * 60 - 1, { leadingZeros: true }), '59:59', 'check 59 minutes looks ok')
  t.equal(f(1000 * 60 * 60 * 24, { leadingZeros: true }), '1:00:00:00', 'check 24 hours is a day')
  t.equal(f(1000 * 60 * 60 * 24 - 1, { leadingZeros: true }), '23:59:59', 'check 23 hours looks okay')
  t.equal(f(1000 * 60 * 60 * 24 * 365, { leadingZeros: true }), '365:00:00:00', 'check 365 days is too long to care')
  t.end()
})
